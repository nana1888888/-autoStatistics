package com.example.excelapplication.config;
...
@MapperScan(        //Mybatis Mapper를 설정하기 위한 어노테이션
        basePackages = {"com.example.excelapplication"},   //Mapper를 찾을 Package를 명시하는 속성
...
public class mybatisConfig {
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier(value = "dataSource") DataSource dataSource) throws Exception {
        ...
        sqlSessionFactoryBean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:mapper/*.xml"));    //Mapper xml파일의 위치를 명시
